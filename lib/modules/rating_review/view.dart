                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            'Overall experience with Service Provider?',
                            style: state.titleTextStyle,
                          ),
                          RatingBar.builder(
              ...
              onTap: () async {
                if (ratingValue1 != 0 &&
                  ...
                  QuerySnapshot query1 = await FirebaseFirestore.instance
                      .collection('shop')
                      .where('id', isEqualTo: widget.orderModel!.get('shop_id'))
                      .get();
                  //---notification
                  FirebaseFirestore.instance
                    ...
                    sendNotificationCall(
                        token, 'Alert!', 'Customer give you ratting');
                  });
                  ...
                  if (query1.docs.isNotEmpty) {
                    ...
                    tempReviewList
                        .add(_ratingReviewLogic.reviewController.text);
